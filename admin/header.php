...
<body id="page-top">
    ...
    <div id="wrapper">
        <!-- Sidebar -->
        <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color:#BD9354">
            <!-- Sidebar - Brand -->
            ...
            <!-- Nav Item - Charts -->
            <li class="nav-item <?= $_SESSION['menu'] == 'gitar' ? 'active':'';?>">
                <a class="nav-link" href="./data_gitar.php">
                    <i class="fas fa-fw fa-chart-area"></i>
                    <span>Data gitar</span></a>
            </li>
